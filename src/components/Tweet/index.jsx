import { faChartBar, faComment, faEllipsis, faHeart, faRetweet, faUpload } from "@fortawesome/free-solid-svg-icons"
    ...
    <div className="border-b border-gray-800 p-4 hover:bg-gray-800 transition-duration-200">
      <div className="flex space-x-3">
        ...
        <div className="flex-1">
          ...
          {tweet.image && <img src={tweet.image} className=" mt-3 rounded-2xl max-w-full h-auto " alt="user image" />}
